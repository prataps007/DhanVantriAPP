...
//        notifyItemInserted(plantDetails.size - 1) // Notify RecyclerView of the new item
        ...
        // Clear existing data before adding new details
        plantDetails.clear()

        // Split the response by newlines or bullet points if needed
        val details = newDetail.split("***")
        plantDetails.addAll(details)
